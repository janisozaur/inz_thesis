...
Ze względu na brak możliwości zakupu stosownego oscylatora, zdecydowałem się wykorzystać wbudowany w mikrokontroler zadajnik częstotliowści. W takiej konfiguracji, w przypadku transmisji danych z prędkością 9600bps\graffito{bps \ppauza baud per second; symbole na sekundę; w przypadku RS232 1 symbol to 1 bit} błąd wynosi zaledwie 0,2\%.\label{sec:usart_error}\graffito{dopisać tłumaczenie dlaczego tak jest}
...
Przeprowadzone testy pokazują, że wspomniany powyżej laptop wykonuje 100000 pełnych cykli takich obliczeń w przeciągu 448ms, co oznacza, że jeden cykl obliczeń zajmuje niecałe 5\textmu s.\graffito{dodać na koniec podsumowanie ograniczeń i wybrać to realne}
...
Czas przesłania jednego raportu\graffito{opisać czym jest raport} obliczamy wzorem:
\begin{equation}
...
\begin{tabularx}{1.5\textwidth}{XXXX} \toprule
    ...
    Prędkość raportowania & ponad 600Hz & do 100Hz & do 25Hz \\
