...
\lstinputlisting[caption=Badanie prędkości kontrolera Sixaxis, title=Badanie prędkości kontrolera Sixaxis]{testy/sixaxis.txt}
...
\lstinputlisting[caption=Badanie prędkości kontrolera Wiimote, title=Badanie prędkości kontrolera Wiimote]{testy/wiimote.txt}
