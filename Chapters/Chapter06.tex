...
\lstinputlisting[title=Badanie prędkości kontrolera Sixaxis]{testy/sixaxis.txt}
...
\lstinputlisting[title=Badanie prędkości kontrolera Wiimote]{testy/wiimote.txt}
