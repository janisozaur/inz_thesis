...
\section{Założenia}
O pewnym ciele mówimy, że jest \textsl{swobodne}, jeśli nie istnieją ograniczenia, które uniemożliwiałyby mu wykonanie \textsl{dowolnych} ruchów \graffito{Inercjalny układ odniesienia to układ na który nie działają żadne siły lub siły na niego działające równoważą się.}w~inercjalnym układzie odniesienia pod wpływem zewnętrznych sił.

\index{stopień swobody}
Mianem \textsl{stopnia swobody} określamy ilość niezależnych\graffito{Niezależnych \ppauza niemożliwych do uzyskania za pomocą złożenia innnych ruchów.} ruchów, jakie może wykonać pewne swobodne ciało sztywne.
...
Ponieważ wykorzystany sprzęt pozwala śledzić tylko i wyłącznie pozycję markerów, można na tej podstawie przyjąć, że marker stanowi pewien nieważki, swobodny punkt materialny. Oznacza to, że posiada on trzy stopnie swobody związane z translacją.
...
Oprogramowanie działa zarówno na mikrokontrolerze \textsmaller{AVR Atmega8}, będącym jedynym programowalnym elementem części sprzętowej, jak i na komputerze.
