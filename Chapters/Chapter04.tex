...
Ponieważ markery nie mogą nadawać sygnału ani jednocześnie, ani ciągle, konieczna jest pewna metoda, w wyniku realizacji której markery będą naprzemiennie nadawać sygnał, a informacja o jego odebraniu będzie zapisana oraz przesłana do komputera. Odbywa się to w następujący sposób:
\begin{enumerate}
