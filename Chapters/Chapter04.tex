...
Dane, jakie przekazywane są do komputera w celu dalszej obróbki zawierają, poza specyfikacją \index{protkół}protokołu, tylko i wyłącznie odczyty z licznika dla każdego z odbiorników.
