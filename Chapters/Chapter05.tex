...
Zadaniem mikrokontrolera jest prowadzenie pomiarów interwałów dzielących rozpoczęcie nadawania przez marker od odebrania sygnału przez odbiorniki.
...
Interfejs aplikacji wraz z przykładowymi danymi prezentuje rysunek \ref{fig:trilaterator}.
