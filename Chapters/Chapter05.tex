...
\graffito{ \includegraphics[width=\marginparwidth]{gfx/gnuhead_inkscape.pdf} Logo Fundacji Wolnego Oprogramowania \ppauza Free Software Foundation}Sama praca udostępniana jest na zasadach otwartej licencji \textsc{GNU GPL 3.0}.
...
Przybycie każdego raportu powoduje aktualizację stanu klasy \verb|GLWidget| oraz ponowne przeliczenie kątów w zgięciach ręki. W miejscu dłoni każdej z rąk umocowana jest sfera, która jest ciałem kinematycznym\graffito{Ciało kinematyczne może powodować akcje w silniku fizyki, lecz nie jest ich odbiorcą}. Pozwala to na uderzenie ustawionych pudełek i obserwację ich zachowań.
